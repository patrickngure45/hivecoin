...
const Login = () => {
  ...
  // State for Form Data (Removed 'name' and 'terms' compared to Sign Up)
  ...
  return (
    <main className="container">
      ...
      `}</style>
        ...
        {/* LEFT SIDE: Branding & Visual (Identical to Sign Up) */}
        <div
        ...
        >
          ...
          <div className="relative z-10 max-w-lg fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-8">
              Access your dashboard to manage liquidity, track yields, and govern the protocol with
          ...
          >
            &copy; 2023 Hive Protocol. All rights reserved.
          </div>
        </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  ...
                  <a href="#" className="text-xs font-medium text-[#DC2626] hover:text-red-400">
                    Forgot password?
                  </a>
                </div>
                <div className="relative">
              ...
              {/* Remember Me Checkbox (Replaces Terms) */}
