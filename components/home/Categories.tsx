  ...
  try {
    ...
    const columns: DataTableColumn<Category>[] = [
      ...
      },
      {
        ...
        cellClassName: 'top-gainers-cell hidden sm:table-cell',
        cell: (category) => (
          <div className="flex items-center gap-2 flex-wrap">
            {category.top_3_coins.map((coin) => (
              <Image src={coin} alt={coin} key={coin} width={24} height={24} />
            ))}
          </div>
        ),
      },
      ...
      },
      {
        ...
        cellClassName: 'market-cap-cell hidden lg:table-cell',
